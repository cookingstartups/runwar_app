...
// stays a thin entrypoint: it imports this function and calls
// Deno.serve(handleClaimTerritoryRequest) unconditionally, the same
// pattern every other function under supabase/functions/ uses.
